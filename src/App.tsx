...
import './App.css';
import { IniciarSesion, PaginaInicio, PaginaPreMatricula, PaginaFormularioFut, PaginaCargarDocumentos, PaginaEliminarDocumentos, AsignarDocente, MallaCurricular } from './views/features/index.tsx';
